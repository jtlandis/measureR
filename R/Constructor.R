...
setGeneric("Const_Weight", valueClass = "Measure", function(object, Class, unit) standardGeneric("Constructor"))
...
setGeneric("Const_Distance", valueClass = "Measure", function(object, Class, unit) standardGeneric("Constructor"))
...
setGeneric("Const_Time", valueClass = "Measure", function(object, Class, unit) standardGeneric("Constructor"))
...
setGeneric("Const_Temperature", valueClass = "Measure", function(object, Class, unit) standardGeneric("Constructor"))
